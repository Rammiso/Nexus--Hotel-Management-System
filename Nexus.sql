...
DROP DATABASE IF EXISTS nexushotel;
CREATE DATABASE IF NOT EXISTS nexushotel;

DROP USER IF EXISTS'nexus_user'@'%';
CREATE USER IF NOT EXISTS 'nexus_user'@'%' IDENTIFIED BY 'password';
GRANT ALL PRIVILEGES ON nexushotel.* TO 'nexus_user'@'%';
USE nexushotel;
